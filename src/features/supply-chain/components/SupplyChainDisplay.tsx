...
import { getSupplyChainHistory, getEnhancedBatchData, generateCurrentCertificate } from '@/features/supply-chain/utils/supplyChainTracker';
import { SupplyChainTransaction } from '@/features/certificate/utils/certificateGenerator';
import { 
  History, 
  Download, 
  User, 
